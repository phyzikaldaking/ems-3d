...
- Name: smoke.spec.ts >> marketplace checkout fails gracefully when payments are not configured
- Location: tests/smoke.spec.ts:92:5
...
Call log:
  - waiting for getByRole('button', { name: /^License$/ }).first()
